...
fn main() {
    ...
    // $ cargo run -- tests/files/bot tests/files/bot/locales -l en -K LF -K cls_i18n -p self -p cls -I core --ignore-kwargs when --comment-junks --default-ftl-file _default.ftl --comment-keys-mode warn --dry-run
