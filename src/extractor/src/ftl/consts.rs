...
pub static DEFAULT_I18N_KEYS: LazyLock<HashSet<String>> = LazyLock::new(|| {
    HashSet::from([
...
pub static DEFAULT_EXCLUDE_DIRS: LazyLock<HashSet<String>> = LazyLock::new(|| {
    HashSet::from([
        "**/.venv/**".to_string(),
        "**/venv/**".to_string(),
        "**/.git/**".to_string(),
...
pub static DEFAULT_IGNORE_ATTRIBUTES: LazyLock<HashSet<String>> = LazyLock::new(|| {
    HashSet::from([
...
pub static DEFAULT_IGNORE_KWARGS: LazyLock<HashSet<String>> = LazyLock::new(|| HashSet::new());
